import{A as s,M as a,O as n,J as e,ai as t,u as h}from"./index-a5b235af.js";import{c as d,d as c,a as l}from"./el-main-029f4d07.js";/* empty css               */const u=`<h2>Ajax定义</h2>
...
<p>​	XMLHttpRequest（XHR）对象用于与服务器交互。通过 XMLHttpRequest 可以在不刷新页面的情况下请求特定 URL，获取数据。这允许网页在不影响用户操作的情况下，更新页面的局部内容。<code>XMLHttpRequest</code> 在 <a href="https://developer.mozilla.org/zh-CN/docs/Glossary/AJAX">AJAX</a> 编程中被大量使用。</p>
<h4>axios和ajax的关系</h4>
...
<h2>修改Webpack打包入口和出口</h2>
`;const i=t("div",{class:"glass"},[t("h2",null,"作者碎碎念")],-1),g=["innerHTML"],y={__name:"AJAX",setup(m){return(x,j)=>{const p=c,r=l,o=d;return s(),a(o,null,{default:n(()=>[e(p,{width:"200px"},{default:n(()=>[i]),_:1}),e(r,null,{default:n(()=>[t("div",{innerHTML:h(u),class:"a"},null,8,g)]),_:1})]),_:1})}}};export{y as default};
