...
<p>2.顶点（vertex）</p>
<p>3.边（Edge）</p>
<p>4.邻接（adjacency，简写adj）</p>
<p>5.邻接矩阵（adjacency Matrix）</p>
<p>6.邻接表（adjacency List）</p>
<p>7.深度优先遍历（Depth First Search，简称BFS）</p>
<p>8.广度优先遍历（Breadth First Search，简称DFS）</p>
<h4>无向图</h4>
<ol>
<li>两个顶点之间如果有边连接，那么就视为两个顶点相邻</li>
<li>路径：相邻顶点的序列</li>
<li>圈：起点和终点重合的路径</li>
<li>连通图：任意两点之间都有路径连接的图</li>
<li>度：顶点连接的边数叫做这个顶点的度</li>
<li>树：没有圈的连通图</li>
<li>森林：没有圈的非连通图</li>
</ol>
<h4>有向图</h4>
<p>1.在有向图中，边是单向的：每条边所连接的两个顶点是一个有序对，他们的邻接性是单向的</p>
<p>2.有向路径：相邻顶点的序列</p>
<p>3.有向环：一条至少含有一条边且起点和终点相同的有向路径</p>
<p>4.有向无环图（DAG）：没有环的有向图</p>
<p>5.度：一个顶点的入度与出度之和称为该顶点的</p>
<p>6.入度：以顶点为弧头的边的数目称为该顶点的入度</p>
<p>7.出度：以顶点为弧尾的边的数目称为该顶点的出度</p>
<h2>图的存储方式</h2>
<h4>邻接矩阵</h4>
