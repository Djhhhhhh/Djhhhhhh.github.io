import{A as o,M as e,O as t,J as p,ai as n,u as d}from"./index-c4572e8b.js";import{c,d as s,a as h}from"./el-main-b88ed798.js";/* empty css               */const r=`<h2>文档说明</h2>
...
<p>![954da0f9f93555dd5268362fc6a9931](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\954da0f9f93555dd5268362fc6a9931.jpg)</p>
<p>​	![b8a3d9e2072e29b82b2f635926cd8a9](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\b8a3d9e2072e29b82b2f635926cd8a9.jpg)</p>
<p>​</p>
<p>​	第二种策略便是本文介绍的主角，动态规划。我们在做出第二种选择方式的时候，是因为我们判定出，如果我们要拿一张11的话，我们就要拿出更多数量的1元。相反如果我要是选择5元面额的，我可以使用更少数量的货币。我们也可以换一种更具有逻辑的思维方式，我们要分解一个15元，首先我们拿出一张11元的货币，这时候我们需要面对的问题便变成了如果分解一个4元的货币，然后我们就用一元对4元货币进行分解，最后统计出的答案。我们拿过11元分解，然后再拿5元来分解，重复上述的行为，我们得出先用5元来分解最后总数比上一种情况少，保留答案。</p>
<p>​	这就是动态规划，将一个问题分解为很多子问题，分别求解子问题的解，最后得出大问题的答案。</p>
<h2>动态规划的三要素</h2>
...
<p>![a74adb5aaaf69f322a0cea16cfcab76](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\a74adb5aaaf69f322a0cea16cfcab76.jpg)</p>
...
<h5>](<a href="https://www.luogu.com.cn/problem/P1616">P1616 疯狂的采药 - 洛谷 | 计算机科学教育新生态 (luogu.com.cn)</a>)</h5>
<h6>思路</h6>
...
<p>![31d461b07c4b706347d9f92356ea9d5](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\31d461b07c4b706347d9f92356ea9d5.jpg)</p>
<p>​	动态回归方程如下：
$$
...
<p>​	按照该思路让我们写一份代码。</p>
<p>![17f53b0ac59b81398b480e5464d4544](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\e67b2a07872ce340a36e89b582f844d.jpg)</p>
<p>![17f53b0ac59b81398b480e5464d4544](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\17f53b0ac59b81398b480e5464d4544.jpg)</p>
...
<p>![6fc99bae269fe9823088faebead32e9](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\6fc99bae269fe9823088faebead32e9.jpg)</p>
<p>​	可得出状态回归方程
$$
...
<p>![7d0a4c85dab0d34b58359ce116f2f85](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\7d0a4c85dab0d34b58359ce116f2f85.jpg)</p>
...
<p>​	对于每一个a[i]，如果a[i]能接到LIS后面，就接上去；否则，就用a[i]取更新low数组。具体方法是，在low数组中找到第一个大于等于a[i]的元素low[j]，用a[i]去更新low[j]。如果从头到尾扫一遍low数组的话，时间复杂度仍是O(n^2)。我们注意到low数组内部一定是单调不降的，所有我们可以二分low数组，找出第一个大于等于a[i]的元素。二分一次low数组的时间复杂度的O(logn)，所以总的时间复杂度是O(nlogn)。</p>
<p>​	![fa94732ff6fd8104807aeb92fe29f64](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\fa94732ff6fd8104807aeb92fe29f64.jpg)</p>
<h4>[P1020 [NOIP1999 普及组] 导弹拦截]([P1020 <a href="https://www.luogu.com.cn/problem/P1020">NOIP1999 普及组] 导弹拦截 - 洛谷 | 计算机科学教育新生态 (luogu.com.cn)</a>)</h4>
<h4>思路</h4>
<p>​	同上文。</p>
<h4>代码实现</h4>
...
<p>![70e7540076c3df90ea1464bc05225a0](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\70e7540076c3df90ea1464bc05225a0.jpg)</p>
...
<p>![ed7e8243298b7f35f6c4dbeebb637b0](C:\\Users\\ASUS\\AppData\\Local\\Temp\\WeChat Files\\ed7e8243298b7f35f6c4dbeebb637b0.jpg)</p>
<h4>[P1439 【模板】最长公共子序列](<a href="https://www.luogu.com.cn/problem/P1439">P1439 【模板】最长公共子序列 - 洛谷 | 计算机科学教育新生态 (luogu.com.cn)</a>)</h4>
<h5>思路</h5>
<p>​	与上文所描述相同。</p>
<h5>代码实现</h5>
...
<h2>区间动态规划</h2>
<p>​	区间dp是一种dp的应用，用于解决涉及区间的问题。</p>
<p>​	如果一个问题最终被分解成为两个连续的部分（一个序列被分割为两个子段），然后再合并，那么几乎可以确定是区间规划问题。区间动态规划用于求区间上的最优值，对于整个区间的最优值来说，通过枚举区间左右两部分的分割点（合并点），将问题分解成为左右两部分的子问题，最后将左右两个子问题的最优值进行合并计算得到原问题的最优值。</p>
<p>​	让我们用一道例题来引入该问题</p>
<h4><a href="https://www.luogu.com.cn/problem/P1775">P1775 石子合并(弱化版)</a></h4>
<p>​	让我们首先来分析一下题意。题目中给出具有顺序的一个石子序列，每个数据对应着石子的质量，题目要求我们将石子合并为一堆，每次只能合并相邻的两堆石子，问我们应该如何操作才能使合并的总代价最小。</p>
<p>​	我们看到这个题可能首先会想到贪心的解法，就是将每次都将较小的两堆合在一起，最后会得出一个在贪心理论下的最小代价。但是，在这个题目中，这种想法是不成立的。为什么呢？是因为这道题中我们可以合并的石子每次必须是相邻的两堆，而相邻的两堆合在一起并不一定会让最后的代价最小。</p>
<p>​	这时我们应该想到动态规划的解法，我们就要用到我们所要讲述到的区间动态规划了。</p>
<h6>状态方程设计</h6>
<p>​	对于动态规划问题，状态转移方程设计是问题的关键。对于本问题中，不同的两个相邻区间的代价值，就是本问题的状态。这是因为我们在合并的过程中，每次只关注于每个子区间内的代价为多少。n个石子合并的代价如果我们设置为DP(1,n)，那么在最后一次合并前，一定已经合并成了两堆了，这两堆的分割方法方法有很多的可能性。比如左边的一个石子单独合并为一堆，右边(n-1)个石子合并为一堆。那么我们的问题就转变为了DP(1,1)+DP(1,n)。当然，分割的方式有很多种。</p>
<p>​	由上述所示，我们可以推到出动态规划状态转移方程：
$$
dp[i][k] = min(dp[i][k], dp[i][j] + dp[j + 1][k] + sum[k] - sum[i - 1]);
$$</p>
<h6>核心代码实现</h6>
<pre><code class="language-c++">for (int l = 2; l &lt;= n; l++) {  //枚举区间长度
...
<h4><a href="https://www.luogu.com.cn/problem/CF607B">Zuma</a></h4>
<h6>思路</h6>
<p>​	题意中给出一串宝石序列，我们可以由题目得出当我们每次都可以挑选一个回文的连续子串进行消除，删除后，剩余的串将连接在一起，形成一个新的串，求把串全部删除完需要的最小次数。</p>
<p>​	因为我们需要处理这组序列中的连续回文子串，我们可以看出每个区间的求解都可以分解为更小的两个区间的求解，自然而然的想到用区间DP来求解。</p>
<p>​	设DP(i,j)为左端点为i右端点为j的最优解，不难推导出动态回归方程:
$$
dp[i][j] = min(dp[i][j], dp[i][mid] + dp[mid + 1][j]);
$$</p>
<h6>代码实现</h6>
<pre><code class="language-c++">ll dp[550][550];
ll n;
ll o[550];
int main() {
	fastread();
...
<h2>环形动态规划</h2>
<p>​	环形动态规划指的是，题目中给定的一串序列具有环形特点的一种特殊的区间动态规划题目。</p>
<p>​	我们在上文已经讲过了区间动态规划该怎么进行求解，再加上环形这一特殊条件后，其实对于每个区间来说本质并没有发生太大的改变。那么我们如何处理环形问题呢？我们可以将环形破链，然后复制一份相同的加在该链后面，这样在环形中所能取到的所有区间便在这一整个链中都能取到了。</p>
<h4><a href="https://www.luogu.com.cn/problem/P1880">石子合并</a></h4>
<p>​	本题目在弱化版的基础上，给定的石子序列变成了环形，我们在将环形破坏成链然后再进行一次复制就变成了基本的区间动态规划问题。</p>
<h6>状态方程推导</h6>
<p>​	该问题推导过程与区间动态规划一致，此处就不进行重复讲述。
$$
dp[i][k] = min(dp[i][k], dp[i][j] + dp[j + 1][k] + sum[k] - sum[i - 1]);
$$</p>
<h4>代码实现</h4>
<pre><code class="language-c++">ll dp1[550][550];
ll dp2[550][550];
ll n;
ll o[550];
ll sum[550];
...
`;const j=n("div",{class:"glass"},[n("h2",null,"作者碎碎念"),n("h4",null,"写这种东西还是有点用的!")],-1),g=["innerHTML"],L={__name:"DP",setup(m){return(f,u)=>{const i=s,a=h,l=c;return o(),e(l,null,{default:t(()=>[p(i,{width:"200px"},{default:t(()=>[j]),_:1}),p(a,null,{default:t(()=>[n("div",{innerHTML:d(r),class:"a"},null,8,g)]),_:1})]),_:1})}}};export{L as default};
